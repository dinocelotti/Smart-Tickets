...
export default class PromoTixForm extends Component {
	render() {
		return (
			<form className="pure-form pure-form-stacked" onSubmit={this.props.queryTix}>
				<fieldset className="pure-group">
					...
					<input type="text" id="tixPrice" className="pure-input-3-4" value={this.props.tixPrice} readOnly />
					<label htmlFor="tixQuantity"> Tix Quantity </label>
					<input type="text" id="tixQuantity" className="pure-input-3-4" value={this.props.tixQuantity} readOnly />
					<br />
